...
import {currentProduct} from '../state/product.reducer';
...
export class ProductEditComponent implements OnInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder,
              private productService: ProductService, private store: Store<productState.State>) {
  ...
  ngOnInit(): void {
    ...
    this.store.pipe(select(currentProduct)).subscribe(currentProduct => {
